let firebaseConfig = {}; 
        ...
        // Firebase Imports - CRITICAL FIX: ADD 'limit' HERE
        import { initializeApp, getApps, getApp } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-app.js";
        import { getAuth, GoogleAuthProvider, signInWithPopup, onAuthStateChanged, signOut } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-auth.js";
        import { getFirestore, collection, addDoc, query, orderBy, onSnapshot, serverTimestamp, getDocs, writeBatch, doc, deleteDoc, updateDoc, getDoc, limit } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore.js"; // Ensure 'limit' is imported
    ...
    onAuthStateChanged(auth, (user) => {
        ...
        function loadChatSessions() {
            ...
            sessionsUnsubscribe = onSnapshot(q, (snapshot) => {
                ...
                if (snapshot.empty) {
                    ...
                    if (!activeSessionId && !document.querySelector('.session-item.active')) { 
                        startNewChatSession();
                    }
                    return;
                }
        ...
        function loadChatHistory(sessionIdToLoad) { 
            if (!db || !chatBoxWrapper || !sessionIdToLoad || !currentUserId) { 
            ...
            if(chatBox) chatBox.innerHTML = ''; let initialWelcomeAdded = false; 
